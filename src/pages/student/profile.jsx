        ...
        <div className='bg-gray-900 min-h-[99vh] flex justify-around'>
            ...
            <div className=' bg-gray-900 min-h[90vh]} '>
                ...
                <form class="max-w-md mx-auto">
                    ...
                    <button type="save" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Save</button>
                </form>
...
<textarea id="message" rows="5" class="block p-2.5 w-full text-sm text-slate-800 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-slate-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write your thoughts here..."></textarea>

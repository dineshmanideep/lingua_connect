...
const Student_dashboard = () => {
    ...
    const info=fetch_data();
   
    const reports=[{name:"dinesh",role:"tutor"},{name:"mani",role:"tutor"},{name:"nani",role:"student"}]

    if (!Array.isArray(info)) {
       console.log("Data is not an array") // Check if the data is not an array
    }
  ...
  <div className=' flex flex-col items-center justify-center bg-gray-900 min-h-[100vh]'>

  {info.map(item=>(<div key = {item._id} className="items-center bg-gray-50 rounded-lg shadow sm:flex sm:justify-around max-w-[900px]  m-3 dark:bg-gray-800 dark:border-gray-700">
                            <Link href="#">
